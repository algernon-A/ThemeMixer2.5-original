...
namespace ThemeMixer.UI.CategoryPanels
{
    public class LutsPanel : PanelBase
    {
        ...
        public override void Awake()
        {
            ...
            {
                DebugOutputPanel.AddMessage(PluginManager.MessageType.Message, "Render It! mod is enabled");
                Debug.Log("Theme Mixer 2.5: Render It! mod is enabled");
            }
            else
            {
                Debug.Log("Theme Mixer 2.5: Render It! mod is not enabled");
                DebugOutputPanel.AddMessage(PluginManager.MessageType.Message, "Render It! mod is not enabled");
            }
        }
